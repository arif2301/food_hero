  ...
  if (Notification.permission == "granted") {
    navigator.serviceWorker.getRegistration().then(function(reg) {
      var options = {
        title: "New Mission",
        body:
          "Show what the pick up/drop off details are" /* How do I get location data to display? or do we link them to another page */,
        ...
        actions: [
          ...
          { action: "close", title: "Not this time", icon: "images/xmark.jpg" }
        ]
      };
...
self.addEventListener("push", function(e) {
  var options = {
    ...
    actions: [
      { action: "explore", title: "Accept", icon: "images/checkmark.png" },
      { action: "close", title: "Not this time", icon: "images/xmark.png" }
    ]
  };
  e.waitUntil(self.registration.showNotification("Hello Food Hero!", options));
});
...
var pushSubscription = {
  endpoint:
    "https://android.googleapis.com/gcm/send/f1LsxkKphfQ:APA91bFUx7ja4BK4JVrNgVjpg1cs9lGSGI6IMNL4mQ3Xe6mDGxvt_C_gItKYJI9CAx5i_Ss6cmDxdWZoLyhS2RJhkcv7LeE6hkiOsK6oBzbyifvKCdUYU7ADIRBiYNxIVpLIYeZ8kq_A",
  keys: {
    p256dh:
